...
export function renderPantallaRegistro(
  ...
  const btnIrLogin = contenedor.querySelector("#btn-ir-login") as HTMLButtonElement;
  ...
  btnIrLogin.addEventListener("click", alQuererIniciarSesion);
